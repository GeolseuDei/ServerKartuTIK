...
/**
 *
 * @author https://github.com/venkatsalem/print-pdf
 */
public class classPrint {
    ...
    public static void main(String[] args) throws IOException, PrinterException {
        ...
        classPrint printPDFFile = new classPrint(fis, "Test Print PDF");
        printPDFFile.print();
    }
     ...
     */
    public classPrint(InputStream inputStream, String jobName) throws IOException, PrinterException {
     ...
     * @throws PrinterException
     */
    public classPrint(byte[] content, String jobName) throws IOException, PrinterException {
